            ...
            ->recordActions([
                ...
                Action::make('approve')
                    ...
                    ->form([
                        ...
                        DatePicker::make('warranty_expires_at')->label('Warranty expiry'),
                        DatePicker::make('next_service_at')->label('Next service'),
                    ])
                    ->fillForm(fn (GarageLinkRequest $record) => ['name' => $record->car_name])
                    ->visible(fn (GarageLinkRequest $record) => $record->status === 'pending')
                    ->action(function (GarageLinkRequest $record, array $data) {
