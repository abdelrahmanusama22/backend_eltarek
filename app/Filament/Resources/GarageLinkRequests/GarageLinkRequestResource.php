...
use App\Filament\Resources\GarageLinkRequests\Schemas\GarageLinkRequestForm;
...
class GarageLinkRequestResource extends Resource
{
    ...
    {
        return GarageLinkRequestForm::configure($schema);
    }

    public static function table(Table $table): Table
    {
        return GarageLinkRequestsTable::configure($table);
    }

    public static function getPages(): array
    {
        return [
            'index' => ListGarageLinkRequests::route('/'),
            'view' => ViewGarageLinkRequest::route('/{record}'),
        ];
    }
}
